...
static var _quests_by_id: Dictionary = {}         # StringName -> QuestResource
...
static func ensure_loaded() -> void:
	...
	_load_dir(_QUESTS_DIR, _quests_by_id)
	_initialized = true
...
static func equipment_items() -> Array[EquipmentResource]:
	ensure_loaded()
	var out: Array[EquipmentResource] = []
	for id in _equipment_by_id.keys():
		out.append(_equipment_by_id[id])
	return out
...
static func quests() -> Array[QuestResource]:
	...
	for id in _quests_by_id.keys():
		out.append(_quests_by_id[id])
	return out
